...
class ClientToServer(_message.Message):
    ...
    def __init__(
        ...
        new_stream: _Optional[_Union[NewStream, _Mapping]] = ...,
        request_message: _Optional[_Union[MessageData, _Mapping]] = ...,
        more_request_data: _Optional[bytes] = ...,
        half_close: _Optional[_Union[_empty_pb2.Empty, _Mapping]] = ...,
        cancel: _Optional[_Union[_empty_pb2.Empty, _Mapping]] = ...,
        window_update: _Optional[int] = ...,
    ) -> None: ...
...
class ServerToClient(_message.Message):
    ...
    def __init__(
        ...
        response_headers: _Optional[_Union[Metadata, _Mapping]] = ...,
        response_message: _Optional[_Union[MessageData, _Mapping]] = ...,
        more_response_data: _Optional[bytes] = ...,
        close_stream: _Optional[_Union[CloseStream, _Mapping]] = ...,
        window_update: _Optional[int] = ...,
    ) -> None: ...
...
class Settings(_message.Message):
    ...
    supported_protocol_revisions: _containers.RepeatedScalarFieldContainer[
        ProtocolRevision
    ]
    initial_window_size: int
    def __init__(
        self,
        supported_protocol_revisions: _Optional[
            _Iterable[_Union[ProtocolRevision, str]]
        ] = ...,
...
class NewStream(_message.Message):
    ...
    def __init__(
        ...
        request_headers: _Optional[_Union[Metadata, _Mapping]] = ...,
        initial_window_size: _Optional[int] = ...,
        protocol_revision: _Optional[_Union[ProtocolRevision, str]] = ...,
    ) -> None: ...
...
class MessageData(_message.Message):
    ...
    data: bytes
    def __init__(
        self, size: _Optional[int] = ..., data: _Optional[bytes] = ...
    ) -> None: ...
...
class CloseStream(_message.Message):
    ...
    def __init__(
        self,
        response_trailers: _Optional[_Union[Metadata, _Mapping]] = ...,
...
class Metadata(_message.Message):
    ...
    class MdEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[Metadata.Values, _Mapping]] = ...,
        ) -> None: ...
